                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-slate-900/30 border-b border-slate-700 text-slate-400 text-xs uppercase tracking-wider">
                            ...
                            <th className="px-2 py-3 font-semibold text-right">PnL (%)</th>
                            <th className="px-2 py-3 font-semibold text-right text-emerald-400">Avg Rate</th>
                            ...
                            investments.map((asset) => {
                                ...
                                return (
                                    <tr key={asset.id} className="hover:bg-slate-700/30 transition-colors group">
                                        ...
                                        <td className="px-2 py-3 text-right text-emerald-500/80 font-mono text-sm">฿{parseFloat(asset.exchangeRate).toFixed(2)}</td>
                                        <td className="px-2 py-3 text-right text-white font-bold font-mono">{formatCurrency(marketValue * asset.exchangeRate, 'THB')}</td>
