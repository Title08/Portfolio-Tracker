    ...
    return (
        <div className="fixed inset-0 bg-black/60 dark:bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-[#1e1e1e] rounded-xl border border-slate-200 dark:border-white/10 w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl transition-colors">
                ...
                {/* Header */}
                <div className="p-6 border-b border-slate-100 dark:border-white/10 flex justify-between items-center bg-gray-50 dark:bg-gradient-to-r dark:from-emerald-900/20 dark:to-blue-900/20 rounded-t-xl">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-gradient-to-br from-emerald-600 to-blue-600 rounded-lg shadow-lg shadow-emerald-500/20">
                            <Sparkles className="w-6 h-6 text-white" />
                        </div>
                        <div>
                            <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">AI Market Pulse</h2>
                            <p className="text-xs text-slate-500 dark:text-gray-400">Real-time news summary via Groq</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 text-slate-700 dark:text-gray-300 custom-scrollbar bg-white dark:bg-transparent">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-20 space-y-4">
                            ...
                            <p className="text-lg font-medium text-emerald-600 dark:text-emerald-300 animate-pulse">
                        ...
                        <div className="prose prose-slate dark:prose-invert max-w-none">
                            <style>{`
                                .dark .prose h3 { color: #34d399; margin-top: 1.5em; margin-bottom: 0.5em; font-size: 1.1em; }
                                .dark .prose p { margin-bottom: 1em; line-height: 1.6; color: #e2e8f0; }
                                .dark .prose ul { margin-top: 0.5em; margin-bottom: 0.5em; }
                                .dark .prose li { margin-bottom: 0.25em; color: #cbd5e1; }
                                .dark .prose strong { color: #f8fafc; font-weight: 600; }
                                .prose h3 { color: #059669; margin-top: 1.5em; margin-bottom: 0.5em; font-size: 1.1em; }
                            `}</style>
